...
option_list <- list( 
  ...
  make_option(c("-s", "--sample_name"), help = "output file prefix"),
...
outfile <- paste0(outdir, "/", sample_name, ".rtea.rda")
writeLines("saving workspace to ", outfile)
save(ctea, opt, RTEA, file = outfile)
